...
df <- tibble(x = c(rnorm(1000), c(NA, 13.34,2673.1,4674,NA,4585.2,78.678,NA,2754,
             ...
             y = c(as.character(rnorm(1000)) ,
                   c("a1df",NA,"t4grf", "sv7",NA, "0wdfwf", "13wdf", "e45rgg", "r546gbn",
                   "ad2f",NA,"tg5rf", "s8v",NA, "wd11fwf", "wd46f", "er57gg", "rgb67n",
                   "adf3",NA,"tgrf6", "9sv",NA, "wdfw13f", "wd17f", "ergg68", "rgb85n")))
