...
```{r Ridge regression and finding best value of lambda using CV}
...
```{r Ridge for logistic regression using CV to find best lambda }
...
```{r Lasso for logistic regression using CV to find best lambda }
